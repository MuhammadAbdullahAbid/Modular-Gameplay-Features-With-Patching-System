...
struct FMGFImplementationAbilityMapping
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FMGFImplementationAttributesMapping
{
	GENERATED_BODY()

	// Ability set to grant
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	TSoftClassPtr<UMGFImplementationAbilityAttributeSet> AttributeSetType;
...
struct FGameFeatureAbilitiesEntry
{
	...
	UPROPERTY(EditAnywhere, Category="Abilities")
	TArray<FMGFImplementationAbilityMapping> GrantedAbilities;

	// List of attribute sets to grant to actors of the specified class 
	UPROPERTY(EditAnywhere, Category="Attributes")
	TArray<FMGFImplementationAttributesMapping> GrantedAttributes;
};
